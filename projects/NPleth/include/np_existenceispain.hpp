...
class ExistenceIsPain : public Generator {

public:
    
    ExistenceIsPain() {}
    virtual ~ExistenceIsPain() {}
    
    // delete copy constructors
    ExistenceIsPain(const ExistenceIsPain&) = delete;
    ExistenceIsPain& operator=(const ExistenceIsPain&) = delete;
...
//        }
    ...
    {
        float pitch1 = k1 * k1;
        float octaves = k2 * 3.0f + 0.3f;
        
        waveform.frequency(50.0f + (pitch1 * 5000.0f));
